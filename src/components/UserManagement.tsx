...
const UserManagement: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="flex flex-1 justify-center py-4 px-4 sm:px-6">
        <div className="flex flex-col md:flex-row gap-6 w-full max-w-[1400px]">
          ...
          <div className="flex flex-col flex-1 min-w-0">
            ...
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <p className="flex justify-start items-center gap-4 text-[#0d141c] tracking-tight text-xl sm:text-2xl md:text-[32px] font-bold leading-tight">
              ...
              <button
                ...
                className="group inline-flex items-center gap-2 px-6 py-3 w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5"
              >
                <Plus
            ...
            <div className="px-4 py-3 overflow-x-auto">
              <div className="min-w-full rounded-lg border border-[#cedbe8] bg-slate-50">
                {isLoading ? (

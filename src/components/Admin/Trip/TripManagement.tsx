...
useEffect(() => {
    ...
    // Search filter (incluyendo filtro por id)
    if (searchTerm) {
        filtered = filtered.filter(trip => {
            ...
            const tripId = String(trip._id).toLowerCase();  // Filtro por id
            ...
            return driverName.includes(searchTerm.toLowerCase()) ||
                ...
                tripId.includes(searchTerm.toLowerCase()); // Agregar el filtro por id
        });
    }
          ...
          <div className="px-6 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="relative w-full md:max-w-md">
              ...
              <input
                ...
                placeholder="Search by id, driver, route or plates..."
  ...
  typeof trip.IDTruck === 'object'
    ? `${trip.IDTruck._id || trip.IDTruck._id} - ${trip.IDTruck.plates}`
    : trip.IDTruck
}

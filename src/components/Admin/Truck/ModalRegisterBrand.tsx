...
const ModalBrandRegister: React.FC<Props> = ({ onClose, onCreated }) => {
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Create a new truck brand</p>
            </div>
          </div>
...
export default ModalBrandRegister
